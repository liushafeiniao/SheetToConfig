...
from sheet_to_config.utils.exporter.exporters.protobuf_exporter import (
    ProtobufExporter,
    ProtobufExportError,
)
from sheet_to_config.utils.exporter.protobuf_schema import ProtoSchemaParser
...
class ProtobufExporterTests(unittest.TestCase):
    ...
    def test_write_failure_rolls_back_every_replaced_file(self):
        ...
        with mock.patch(
            "sheet_to_config.utils.exporter.exporters.protobuf_exporter.os.replace",
    ...
    def test_optional_csharp_generation_requires_protoc_and_is_atomic(self):
        ...
        exporter = ProtobufExporter(self._schema(complex_proto_rows()))
        with mock.patch(
            "sheet_to_config.utils.exporter.csharp_generator.shutil.which", return_value=None
    ...
    def test_optional_csharp_generation_writes_to_independent_target(self):
        ...
        exporter = ProtobufExporter(self._schema(complex_proto_rows()))
        with mock.patch(
            "sheet_to_config.utils.exporter.exporters.protobuf_exporter.generate_csharp",
