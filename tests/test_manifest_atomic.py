...
from sheet_to_config.utils.exporter.artifact_manifest import (
    MANIFEST_NAME,
    ArtifactRecord,
    build_manifest,
...
from sheet_to_config.utils.exporter.atomic_writer import AtomicCommitError, commit_files
from sheet_to_config.utils.exporter.batch_transaction import prepare_batch_commit
...
class AtomicWriterTests(unittest.TestCase):
    def test_mid_commit_failure_restores_every_old_file(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                "sheet_to_config.utils.exporter.atomic_writer.os.replace",
