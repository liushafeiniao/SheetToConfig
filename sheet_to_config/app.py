...
from sheet_to_config.version import __version__, APP_TITLE
from sheet_to_config.styles import get_stylesheet
from sheet_to_config.widgets import ElidedLabel, ProjectCardDelegate
from sheet_to_config.utils.project_manager import Project, ProjectManager
from sheet_to_config.utils.export_handler import ExportHandlerAsync
from sheet_to_config.utils.import_handler import ImportHandlerAsync
from sheet_to_config.utils.os_integration import open_local_path
# SVN功能已禁用
# from sheet_to_config.utils.svn_handler import SVNHandlerAsync
from sheet_to_config.theme_config import (
    THEME_PRESETS, load_theme_config, save_theme_config,
    get_current_theme_colors, get_scaled_bg_image, localized_theme_name
)
from sheet_to_config.dialogs import (
    ProjectEditDialog, ThemeDialog, ImportOptionDialog,
    ExportOptionDialog, AboutDialog
)
from sheet_to_config.i18n import (
    LANGUAGE_NAMES, SUPPORTED_LOCALES, get_locale, language_name, set_locale, tr,
)
...
class SheetToConfigWindow(QMainWindow):
    ...
    def _create_right_panel(self):
        ...
        self.detail_toggle_btn.setObjectName("toggleBtn")
        ...
        self.detail_toggle_btn.setMinimumHeight(28)
    ...
    def _create_detail_row(self, parent, label_text, attr_name, path_attr=None, with_sync=False):
        ...
        if with_sync:
            ...
            self.import_btn.setMinimumSize(96, 30)
