...
class ThemeDialog(QDialog):
    ...
    def init_ui(self):
        ...
        select_bg_btn.setMinimumWidth(110)
        ...
        clear_bg_btn.setMinimumWidth(110)
    ...
    def _create_theme_card(self, theme_id, theme):
        ...
        from sheet_to_config.theme_config import localized_theme_name
    ...
    def _refresh_bg_preview(self):
        ...
        if self.result_bg_image:
            from sheet_to_config.theme_config import get_scaled_bg_image
...
class AboutDialog(QDialog):
    ...
    def _build_donate_tab(self):
        """支持作者页：微信 / 支付宝收款码"""
        import os
        from sheet_to_config.version import resource_path
