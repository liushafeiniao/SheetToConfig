...
<p align="center">
  ...
  <a href="https://github.com/liushafeiniao/SheetToConfig/releases"><img alt="현재 버전 1.0.5" src="https://img.shields.io/badge/version-1.0.5-00D4AA?style=flat-square"></a>
...
- 현재 버전: [`sheet_to_config/version.py`](../../sheet_to_config/version.py)의 `1.0.5`
