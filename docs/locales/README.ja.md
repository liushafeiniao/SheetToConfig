...
<p align="center">
  ...
  <a href="https://github.com/liushafeiniao/SheetToConfig/releases"><img alt="現在のバージョン 1.0.4" src="https://img.shields.io/badge/version-1.0.4-00D4AA?style=flat-square"></a>
...
- 現在のバージョン：[`sheet_to_config/version.py`](../../sheet_to_config/version.py) の `1.0.4`
